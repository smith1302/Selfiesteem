...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    var activityIndicator:ActivityIndictator = ActivityIndictator()
    ...
    override func viewDidLoad() {
        ...
        arrow.tintColor = UIColor(netHex: 0x308BF2)
        ...
        blueLine.backgroundColor = UIColor(netHex: 0xAEC5F5)
        ...
        thinLine.backgroundColor = UIColor(netHex: lineColor)
        ...
        thinLine2.backgroundColor = UIColor(netHex: lineColor)
        ...
        thinLine3.backgroundColor = UIColor(netHex: lineColor)
        ...
        loginButton?.backgroundColor = UIColor(netHex: 0x3B5998)
        ...
        registerButton?.backgroundColor = UIColor(netHex: 0x3B5998)
